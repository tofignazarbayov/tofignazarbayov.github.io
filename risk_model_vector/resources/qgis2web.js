...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
        extent: [-180.000000, -90.000000, 180.000300, 87.386000], maxZoom: 28, minZoom: 1, projection: new ol.proj.Projection({
            code: 'EPSG:4326',
            extent: [-180.000000, -90.000000, 180.000300, 87.386000],
            units: 'degrees'})
    })
});
...
map.getView().fit([-180.000000, -90.000000, 180.000300, 87.386000], map.getSize());
