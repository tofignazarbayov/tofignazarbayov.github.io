...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
        extent: [-180.124700, -90.000000, 180.125300, 87.511000], maxZoom: 28, minZoom: 1, projection: new ol.proj.Projection({
            code: 'EPSG:4326',
            extent: [-180.124700, -90.000000, 180.125300, 87.511000],
            units: 'degrees'})
    })
});
...
map.getView().fit([-180.124700, -90.000000, 180.125300, 87.511000], map.getSize());
